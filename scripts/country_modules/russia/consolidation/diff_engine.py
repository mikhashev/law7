...
This is the Russia-specific diff engine for applying amendments to Russian legal codes.
"""
import logging
...
class ArticleDiffEngine:
    """
    Engine for applying amendments to legal code articles (Russia).

    This is the Russia-specific diff engine for applying amendments to
    Russian legal code articles.
