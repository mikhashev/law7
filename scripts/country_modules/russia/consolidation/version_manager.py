...
This is the Russia-specific consolidation engine for tracking historical
...
from country_modules.russia.consolidation.diff_engine import ArticleSnapshot
...
class VersionManager:
    """
    Manages version history of legal code articles (Russia).

    This is the Russia-specific version manager for tracking historical
    versions of Russian legal articles.
